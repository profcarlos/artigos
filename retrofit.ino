/**********
  IFG Campus Goiânia
  Autor:    Regivagno Paixão e Carlos Silveira
  Objetivo: Acionamento de Lampadas via Wi-Fi
  Origem: Essa programação é uma adaptacao de um programa de Fábio Souza
